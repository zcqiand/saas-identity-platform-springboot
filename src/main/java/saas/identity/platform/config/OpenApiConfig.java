 ...
 * openapi-generator 在 build time 把 spec 编成本仓 <code>src/main/java/.../shared/api/*.java</code>
 * 12 个 controller 接口 (带完整 swagger v3 注解)，由本仓 9 个 controller 实现这些接口，
 * 注解在 runtime 被 springdoc 自动扫描合并进 OpenAPI 3.1 doc。无双写。
 *
 * <p>对外公开路径 (SecurityConfig.java v0.1.13 同步 permitAll)：
 * <ul>
 *   <li><code>https://saas-springboot.xiangru.uk/swagger-ui/index.html</code></li>
 *   <li><code>https://saas-springboot.xiangru.uk/v3/api-docs</code></li>
 *   <li><code>https://saas-springboot.xiangru.uk/v3/api-docs.yaml</code></li>
 * </ul>
 */
@Configuration
