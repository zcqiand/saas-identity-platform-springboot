...
public interface TenantRolesApi {
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "The request has succeeded.", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = TenantRolesListRoles200Response.class))
            }),
            @ApiResponse(responseCode = "default", description = "An unexpected error response.", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class))
            })
    ...
    String PATH_TENANT_ROLES_SET_PERMISSIONS = "/api/v1/tenants/{tenantId}/roles/{roleId}/permissions";
    /**
    ...
    ResponseEntity<Role> tenantRolesSetPermissions(
        @Parameter(name = "tenantId", description = "", required = true, in = ParameterIn.PATH) @PathVariable("tenantId") String tenantId,
        @Parameter(name = "roleId", description = "", required = true, in = ParameterIn.PATH) @PathVariable("roleId") String roleId,
        @Parameter(name = "TenantRolesSetPermissionsRequest", description = "", required = true) @Valid @RequestBody TenantRolesSetPermissionsRequest tenantRolesSetPermissionsRequest
    );
