...
public interface AdminTenantsApi {
    ...
    ResponseEntity<Tenant> adminTenantsCreateTenant(
        @Parameter(name = "CreateTenantRequest", description = "", required = true) @Valid @RequestBody CreateTenantRequest createTenantRequest
    );
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "The request has succeeded.", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = AdminTenantsListTenants200Response.class))
            }),
            @ApiResponse(responseCode = "default", description = "An unexpected error response.", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class))
            })
    ...
    ResponseEntity<Tenant> adminTenantsUpdateTenant(
        @Parameter(name = "id", description = "", required = true, in = ParameterIn.PATH) @PathVariable("id") String id,
        @Parameter(name = "UpdateTenantRequest", description = "", required = true) @Valid @RequestBody UpdateTenantRequest updateTenantRequest
    );
