...
public class TenantUsersListUsers200Response {
   ...
   */
  public TenantUsersListUsers200Response(List<@Valid User> items, Integer page, Integer pageSize, Long total) {
    this.items = items;
    this.page = page;
  ...
  public boolean equals(Object o) {
    ...
    TenantUsersListUsers200Response tenantUsersListUsers200Response = (TenantUsersListUsers200Response) o;
