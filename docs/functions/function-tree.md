# saas-identity-platform-springboot 功能树

> 多租户 SaaS 身份管理 — React 前端。consumes `saas-identity-platform-shared` TypeSpec SSOT。
...
| M05.F01.I05    | 物理删除 API Key（区别于 I03 revoke 软删） | 接口 | 已上线 |
